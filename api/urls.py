...
urlpatterns = [
    ...
    path("api/evaluate/<int:id>/", RetrieveEvaluationRequest.as_view(), name="retrieve-evaluation"),  # GET request ,<id> where you should add real ID to fetches the status and result of the evaluation
]
